...
print(f"Cross-val Score : {cv_scores.mean():.2f} (+/- {cv_scores.std():.2f})")
...
WHITE  = "#f0f0f0"
MUTED  = "#888888"
COLORS = ["#4f9cf9", "#f97b4f", "#4fd97b", "#f9c84f", "#c44ff9", "#f94f6e"]
BLUE   = "#4f9cf9"
GREEN  = "#4fd97b"
RED    = "#f94f6e"
...
ticks   = [0, 1]
ax2.set_xticks(ticks); ax2.set_xticklabels(classes, color=MUTED, fontsize=8)
ax2.set_yticks(ticks); ax2.set_yticklabels(classes, color=MUTED, fontsize=8, rotation=90, va="center")
...
style_ax(ax4, "4. Cross-Validation Scores (5-Fold)")
...
style_ax(ax5, "5. Feature Importance")
...
print("Model saved as cloud_model.pkl")
...
with open("model_metrics.txt", "w") as f:
    ...
    f.write(f"Cross-val Mean    : {cv_scores.mean():.4f}\n")
    f.write(f"Cross-val Std     : {cv_scores.std():.4f}\n")
